 ...
 */
var PartProperty = function (name, value, showInLabel = false) {
 ...
 * @param {boolean} [sticky = false] Whether this PartLayer can be "sticky", so that any other PartLayers "above" this PartLayer move with it. The parameter should only be true if this PartLayer corresponds to {@link PartViewSettings} with name "pcb"
 */
var PartLayer = function (id, sticky = false) {
  this.id = id
  this.sticky = sticky
}
 ...
 * @constructor
 * @param {string} name The name of the view associated with these {@link PartViewSettings}. The parameter should be one of four possible values: **breadboard**, **icon**, **pcb**, and **schematic**
 * @param {string} image The relative path to the SVG image for the view
 * @param {PartLayer[]} layers The {@link PartLayer}s of the {@link Part} for the corresponding view
 * @param {boolean} [flipHorizontal = false] Whether the {@link Part} can be horizontally flipped in the view
 * @param {boolean} [flipVertical = false] Whether the {@link Part} can be vertically flipped in the view
 */
var PartViewSettings = function (name, image, layers = [], flipHorizontal = false, flipVertical = false) {
  this.name = name
  this.image = image
  this.layers = layers
 ...
 * @constructor
 * @param {string} name The name of the corresponding layer
 * @param {string} svgId The ID of the SVG element associated with the corresponding layer and view of a {@link PartConnector}
 * @param {string} terminalId The ID of the SVG element describing the custom terminal point associated with the corresponding layer and view of a {@link PartConnector}
 * @param {string} legId The ID of the SVG element representing a bendable "rubber-band" leg associated with the corresponding layer and view of a {@link PartConnector}. The parameter should only be defined if **terminalId** is not
 * @param {string} disabled Whether a {@link PartConnector} should be disabled in the corresponding layer and view. The parameter has been renamed from **hybrid** in Fritzing FZP files
 */
var PartConnectorLayerSettings = function (name, svgId, terminalId, legId, disabled = false) {
  this.name = name
  this.svgId = svgId
 ...
 * @constructor
 * @param {string} id The ID of this PartConnector
 * @param {string} name The name of this PartConnector
 * @param {string} type The arbitrary type of this PartConnector
 * @param {string} description The description of this PartConnector
 * @param {string} replacedBy The ID of the PartConnector that renders this PartConnector obsolete
 * @param {ERC} erc The {@link ERC} (Electric Rule Check) of this PartConnector
 * @param {PartConnectorViewSettings} viewSettings The {@link PartConnectorViewSettings} of this PartConnector
 */
var PartConnector = function (id, name, type, description, replacedBy, erc, viewSettings = []) {
  this.id = id
  this.name = name
  this.type = type
 ...
 * @param {string} params.id The ID of this Part. The parameter has been renamed from **moduleId** in Fritzing FZP files
...
/**
 * Returns the Part file as a string of FZP XML
 * @return {Promise} The Part file as a string of FZP XML
 */
...
/**
 * Returns a Promise that resolves with a {@link Part} object
 * @return {Promise} A Promise that resolves with a {@link Part} object
 */
