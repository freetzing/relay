 ...
 * @constructor
 * @class
 * @classdesc A *functional* subcomponent of a {@link Part} that can only interface with other {@link Part} subcomponents in the same layer for a specific view
 ...
 * @param {string} flow The flow of the Current
 * @param {number} valueMax The maximum value of the Current
 */
