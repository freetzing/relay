...
var { SketchBundle, PartBundle, PartBinBundle } = require('./bundle')
 ...
 * @param {string} dataType The data type of the data that will be converted once {@link Builder#build} is called
 * @return {Builder} The {@link Builder} instance that is being put together
 */
Builder.prototype.from = function (format, dataType) {
...
/**
 * Saves the desired data type in the {@link Builder} configuration of the target data that will be produced once {@link Builder#build} is called
