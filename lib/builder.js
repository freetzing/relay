...
var { Bin } = require('./fritzing/bin')
var { SketchBundle, PartBundle, BinBundle } = require('./fritzing/bundle')
      ...
      case 'fritzing':
        switch (_this.type) {
          ...
          case 'fzp':
            ...
            break
          case 'fzb':
            fromPromise = Bin.fromFZB(_this.data)
            break
          case 'fzz':
          ...
          case 'fzpz':
            ...
            break
          case 'fzbz':
            fromPromise = BinBundle.fromFZBZ(_this.data)
            break
        }
        break
      case 'eagle':
